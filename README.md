...
- Création d'un blog culturel [Les faces cachées de Bordeaux - Atelier Blog'Art](https://github.com/flavie25/FacesCacheesDeBordeaux)

- Création d'un site one page [Tech'Art - Atelier Main dans la main](https://github.com/alvina-dr/tech-art)

- Refonte d'un site web [Cinéma Le Festival - Atelier Design interactif](https://github.com/Alyssalade/cinema_animation)
